    ...
    <div class="sub-product">
      <div class="prod-container">
        ...
        <div class="price-cart">
          <div>R11999.00</div>
          <div><button class="product" onclick="addToCartCount()" data-name="Hisense 65'' class H6500F" data-price="11999.00" data-image="images/HisenseTv.jpg"><img src="images/cart-plus-fill.svg" alt="not visible" class="cart-icon"></button></div>
        </div>
      </div>
